...
var _ (interfaces.HubApiProvider) = (*hubitat)(nil)
...
func NewHubitatProvider(ctx context.Context, hubHost *entities.HubHost) interfaces.HubApiProvider {
	...
	// initialize device list with bound data var
	provider.host.DeviceDetails = provider.DeviceDetailsList()
...
func (h *hubitat) CreateDeviceEventListener() bool {
	...
	go func(p *hubitat) { // shutdown monitor
		var ev entities.DeviceEventStream
